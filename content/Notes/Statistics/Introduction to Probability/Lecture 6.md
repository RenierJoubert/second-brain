...
\end{align}
$$
Recall the formula for calculating $\begin{pmatrix}n \\  m\end{pmatrix}$, "n choose m" from [[content/Notes/Statistics/Introduction to Probability/Lecture 3|Combinations]].
